...
class MidasSerial:
    ...
    def __init__(self, port: str, baudrate: int, stopbits: float,
                 parity: str, databits: float, timeout: float):
        self.port = port
    ...
    def serial_write(self, command: str, node_id: int = 0):
        """
...
class Status:
    ...
    def __init__(self, serialconn: MidasSerial):
    ...
    def get_status_word(self, node_id: int = 0):
        """
    ...
    def get_status_bit(self, node_id: int = 0):
        """
    ...
    def get_last_error_code(self, node_id: int = 0):
        """
    ...
    def get_alarms(self, node_id: int = 0):
        """
    ...
    def get_system_running_hours(self, node_id: int = 0):
        """
    ...
    def get_alarm_masks(self, node_id: int = 0):
        """
    ...
    def set_alarm_masks(self, alarm_mask: str, node_id: int = 0):
        """
    ...
    def set_critical_alarms(self, alarm_mask: str, node_id: int = 0):
        """
    ...
    def clear_alarms(self, node_id: int = 0):
        """
    ...
    def get_fill_cycles(self, node_id: int = 0):
        """
...
class Pressures:
    ...
    def get_return_pressure(self, node_id: int = 0):
        """
    ...
    def set_return_pressure(self, pressure: str, node_id: int = 0):
        """
    ...
    def get_non_recirc_meniscus_pressure(self, node_id: int = 0):
        """
    ...
    def set_non_recirc_meniscus_pressure(
            self, pressure: str, node_id: int = 0):
        """
    ...
    def get_infeed_pressure(self, node_id: int = 0):
        """
    ...
    def set_infeed_pressure(self, pressure: str, node_id: int = 0):
        """
    ...
    def get_pressure_sensor_type(self, node_id: int = 0):
        """
        ...
        self.pressure_sensor_type['actual'] = self.serialconn.serial_response(
            "get")
        return self.pressure_sensor_type['actual']

    def set_pressure_sensor_type(self, sensor_type: str, node_id: int = 0):
        """
...
class Temperatures:
    ...
    def get_heater_temp_1(self, node_id: int = 0):
        """
    ...
    def get_tank_temperature(self, node_id: int = 0):
        """
        Read current target tank heater temperature
        Degrees C (0-60)
        """
        self.serialconn.serial_write("SHT?\r", node_id)
        self.tank_temperature['actual'] = self.serialconn.serial_response(
            "get")
        return self.tank_temperature['actual']

    def set_tank_temperature(self, temperature: str, node_id: int = 0):
        """
    ...
    def get_aux_temperture(self, node_id: int = 0):
        """
    ...
    def set_aux_temperture(self, temperature: str, node_id: int = 0):
        """
    ...
    def get_preheat_time(self, node_id: int = 0):
        """
        Read preheat time
        Seconds (0-600)
        """
    ...
    def set_preheat_time(self, time: str, node_id: int = 0):
        """
        Set preheat time
        Seconds (0-600)
        """
    ...
    def get_heater_1_duty(self, node_id: int = 0):
        """
    ...
    def set_heater_1_duty(self, duty: str, node_id: int = 0):
        """
    ...
    def get_heater_2_duty(self, node_id: int = 0):
        """
    ...
    def set_heater_2_duty(self, duty: str, node_id: int = 0):
        """
...
class Pumps:
    ...
    def get_pump_timeout(self, node_id: int = 0):
        """
    ...
    def set_pump_timeout(self, timeout: str, node_id: int = 0):
        """
    ...
    def get_manual_recirc_speed(self, node_id: int = 0):
        """
        Read Manual Recirc speed
        Internal (0-700)
        """
        self.serialconn.serial_write("SMR?\r", node_id)
        self.manual_recirc_speed['actual'] = self.serialconn.serial_response(
            "get")
        return self.manual_recirc_speed['actual']

    def set_manual_recirc_speed(self, speed: str, node_id: int = 0):
        """
    ...
    def get_fill_speed(self, node_id: int = 0):
        """
    ...
    def set_fill_speed(self, speed: str, node_id: int = 0):
        """
    ...
    def get_recirc_pump_command(self, node_id: int = 0):
        """
    ...
    def get_manual_meniscus(self, node_id: int = 0):
        """
        Runs the meniscus pump at the fixed minimum speed on HV controllers to
        allow the setting of the minimum meniscus pressure
        1 or 0
        """
        self.serialconn.serial_write("SNI?\r", node_id)
        self.manual_meniscus_state['actual'] = self.serialconn.serial_response(
            "get")
        return self.manual_meniscus_state['actual']

    def set_manual_meniscus(self, enable: str, node_id: int = 0):
        """
        Runs the meniscus pump at the fixed minimum speed on HV controllers to
        allow the setting of the minimum meniscus pressure
        1 or 0
    ...
    def get_meniscus_pump_command(self, node_id: int = 0):
        """
...
class Purge:
    ...
    def get_purge_pressure(self, node_id: int = 0):
        """
    ...
    def set_purge_pressure(self, pressure: str, node_id: int = 0):
        """
    ...
    def get_purge_status(self, node_id: int = 0):
        """
    ...
    def triger_purge(self, purge_type: str, node_id: int = 0):
        """
    ...
    def get_purge_time(self, node_id: int = 0):
        """
    ...
    def set_purge_time(self, time: str, node_id: int = 0):
        """
    ...
    def get_local_purge_time(self, node_id: int = 0):
        """
        Read local purge time
        Seconds (0-60)
        """
        self.serialconn.serial_write("SLP?\r", node_id)
        self.local_purge_time['actual'] = self.serialconn.serial_response(
            "get")
        return self.local_purge_time['actual']

    def set_local_purge_time(self, time: str, node_id: int = 0):
        """
...
class Midas:
    ...
    def create_serial_connection(self, port: str, baudrate: int = 115200,
                                 ...
                                 parity: float = serial.PARITY_NONE,
                                 databits: float = serial.EIGHTBITS, timeout=1):
        """
    ...
    def get_firmware_version(self, node_id: int = 0):
        """
    ...
    def get_serial_number(self, node_id: int = 0):
        """
    ...
    def get_system_type(self, node_id: int = 0):
        """
    ...
    def set_active_heads(self, heads: str, node_id: int = 0):
        """
        Set active heads
    ...
    def get_bypass_time(self, node_id: int = 0):
        """
        Read bypass time
        Seconds (0-600)
        """
    ...
    def set_bypass_time(self, time: str, node_id: int = 0):
        """
        Set bypass time
        Seconds (0-600)
        """
    ...
    def set_startup_function(self, function: str, node_id: int = 0):
        """
        ...
        midas_response = self.serialconn.serial_response("set")
        if midas_response is True:
            self.startup_function = function
        return midas_response

    def get_drain_status(self, node_id: int = 0):
        """
    ...
    def set_drain(self, drain_type: str, node_id: int = 0):
        """
    ...
    def get_prime_system_status(self, node_id: int = 0):
        """
    ...
    def set_prime_system(self, enable: str, node_id: int = 0):
        """
    ...
    def get_network_id(self, node_id: int = 0):
        """
    ...
    def set_network_id(self, network_id: str, node_id: int = 0):
        """
    ...
    def get_enable_bits(self, node_id: int = 0):
        """
    ...
    def set_enable_bits(self, enable_bits: str, node_id: int = 0):
        """
    ...
    def get_extended_enable_bits(self, node_id: int = 0):
        """
        ...
        self.extended_enable_bits['actual'] = self.serialconn.serial_response(
            "get")
        return self.extended_enable_bits['actual']

    def set_extended_enable_bits(self, enable_bits: str, node_id: int = 0):
        """
    ...
    def get_dynamic_calibration_state(self, node_id: int = 0):
        """
        Gets dynamic calibration on the system
        Decimal
        """
        self.serialconn.serial_write("SDC?\r", node_id)
        self.dynamic_calibration_state['actual'] = self.serialconn.serial_response(
            "get")
        return self.dynamic_calibration_state['actual']

    def set_dynamic_calibration_state(
            self, calibration: str, node_id: int = 0):
        """
